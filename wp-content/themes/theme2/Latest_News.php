<?php
   /* Template Name: Latest SKRAU News*/
   get_header();
   ?>
<style>
   .for_bold{
                  ...
                  <div class="program-syllabus-sec">
                     <div id="ContentPlaceHolder1_Panel1">
                        <div class="col-md-12" id="overviewmaindiv">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-6">
                                     <p class="show-archive"><a href="<?php echo site_url('/archive-latest-news')?>" style="color:#000;">Show Archive</a></p>
                                 </div>
                                 </div>
                                 <?php 
                                    $start = 1;
                                       $endpost = 10 ;
                                    ?>
                                 <div class="js-filter col-md-12" style="margin-top: 30px;">
                                    <?php 
                                       $args = array(
                                           'post_type'=>'post',
                                           'posts_per_page'=>-1,
					...
					'category_name' => 'latest-skrau-news'
                                    ...
                                    <div class="col-md-12 all-content" id="limitid<?php echo $start; ?>" style="display:none; margin-bottom: 35px;">
                                       ...
                                       <span class="heading_news_events"><i class="fa fa-calendar calender-icon" aria-hidden="true" style="color:red;"></i>&nbsp; Posted On <?php echo get_the_date();?> </span> ~~<span style="color:#000;font-weight: 600; margin: 0;"><?php echo $category[0]->cat_name; ?></span>
