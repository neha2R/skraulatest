                  ...
                  <div class="program-syllabus-sec">
					...
					'order' => 'ASC',
                                    ...
                                    <div class="col-md-12 all-content" id="limitid<?php echo $start; ?>" style="display:none; margin-bottom: 35px; ">
                                       <span class="heading_news_events"><i class="fa fa-calendar calender-icon" aria-hidden="true" style="color:red;"></i>&nbsp; Posted On <?php echo get_the_date();?> </span>
