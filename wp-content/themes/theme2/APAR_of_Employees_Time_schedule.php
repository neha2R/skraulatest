...
<?php
   /* Template Name: APAR of Employees Time schedule */
   get_header();
   ?>
 <style>
   .btn {
                           ...
                           <div class="col-md-12" id="overviewmaindiv">
                               <div class="col-md-3" id="overviewmaindiv1">
                                ...
                                <div class="col-md-9" id="overviewmaindiv2">
                                   ...
                                   <h2 class="welcome-title"><p>APAR of Employees & Time Schedule</p></h2>
                                   <div class="col-md-12">
                              <img src="<?php bloginfo('template_directory');?>/images/untitled_12.jpg" class="all_images_header"/>
